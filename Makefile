...
SOURCES = rect.ml file.ml config.ml video.ml audio.ml event_manager.ml vfs.ml medias.ml music.ml anim.ml cursors.ml otype.ml oxml.ml olua.ml  interface.ml iface_event.ml stage.ml dijkstra.ml pathfinding.ml action.ml 
